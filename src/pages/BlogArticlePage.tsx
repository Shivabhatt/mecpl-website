      ...
      <section className="relative overflow-hidden border-b border-white/5">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24">
          ...
          <div className="max-w-4xl space-y-6">
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase text-white leading-none max-w-5xl">
              {post.title}
            </h1>
            <p className="text-gray-300 text-base md:text-lg max-w-3xl leading-relaxed">{post.deck}</p>
          </div>
        </div>
      </section>
          ...
          <div className="space-y-8">
            {post.sections.map((section) => (
              <section key={section.heading} className="rounded-[28px] border border-white/5 bg-mecpl-card p-6 md:p-8">
                <h2 className="text-white text-2xl md:text-3xl font-black uppercase tracking-tight">{section.heading}</h2>
