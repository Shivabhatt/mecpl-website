    ...
    <div data-animate-page className="about-page font-montserrat font-medium" style={{ background: "#ffffff", fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <section style={{ position: "relative", height: "100vh", overflow: "hidden", background: "#111" }}>
        ...
        <div style={{
          ...
          <h1 className="page-title-font font-montserrat about-hero-title" style={{ fontFamily: "Montserrat, sans-serif", fontWeight: 300, fontSize: "clamp(1.6rem, 4vw, 3.2rem)", color: "#ffffff", letterSpacing: "-0.01em", lineHeight: 0.95, margin: 0, textTransform: "none" }}>
            Our Story
          </h1>
        </div>
        {/* Scroll cue */}
