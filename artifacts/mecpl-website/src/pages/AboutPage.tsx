    ...
    <div data-animate-page style={{ background: "#ffffff", fontFamily: "'Montserrat', sans-serif" }}>
      ...
      <section id="abt1" style={{ background: "#ffffff", padding: "90px 56px 0", scrollMarginTop: 80 }}>
        <div style={{ maxWidth: 1360, margin: "0 auto" }}>
          ...
          {/* ② Our Story text — below images, 2-col layout */}
          <RevealBlock delay={100}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "start", paddingBottom: 72, borderBottom: "1px solid rgba(0,0,0,0.08)" }}>
              <div>
                ...
                <p style={{ fontFamily: "'Montserrat',sans-serif", fontSize: "1.05rem", color: "#1a1a1a", lineHeight: 1.85, margin: 0, fontWeight: 500 }}>
