          ...
          <RevealBlock delay={100}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 72, alignItems: "start", paddingBottom: 72, borderBottom: "1px solid rgba(0,0,0,0.08)" }}>
              ...
              <div>
                ...
                <h2 style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 800, fontSize: "clamp(1.6rem, 2.5vw, 2.2rem)", color: "#111", letterSpacing: "-0.03em", lineHeight: 1.2, margin: 0 }}>
                  Building Pune's Skyline Since 2001
                </h2>
              </div>
